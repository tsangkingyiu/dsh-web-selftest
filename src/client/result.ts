...
export function webResultSummaryOf(block: ToolCallViewProps['block']): WebResultSummary | undefined {
  ...
  for (const item of block.content) {
    ...
    const summary: WebResultSummary = {}
    ...
    if (bytes === undefined && width === undefined && height === undefined && action === undefined && path === undefined && sessionId === undefined) continue
...
export function webResultTextOf(block: ToolCallViewProps['block']): string | null {
